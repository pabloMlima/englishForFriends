...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
        ...
        <div class="fixed-bottom">
            <footer class="py-2 bg-dark text-white-50 back-footer">
                <div class="container text-center">
                    <x-buttons.button-link  class=" font-c-footer resp-ico">
                        <i class="fas fa-envelope"></i> pablomlima75@gmail.com
                    </x-buttons.button-link>
                    <x-buttons.button-link blank href="http://linkedin.com/in/pablo-machado-lima-42820a194" class=" font-c-footer marg-c-footer resp-ico" >
